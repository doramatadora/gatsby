  ...
  useEffect(() => {
    if (pageComponent?.Head) {
      ...
      render(
        ...
        // Note: In dev, we call onHeadRendered twice (in FireCallbackInEffect and after MutationObserver detects initial render into hiddenRoot) this is for hot reloading
